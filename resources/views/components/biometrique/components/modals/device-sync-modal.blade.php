<div id="deviceSyncModal" 
    x-data="{ 
        ...
        async synchronizeDevice() {
            if (!this.appareilId) {
                this.message = 'Aucun appareil sélectionné pour la synchronisation.';
                this.status = 'error';
                return;
            }
            ...
            try {
                const response = await fetch(`/biometrique/appareils/${this.appareilId}/sync`, {
                    method: 'POST',
                    headers: {
                ...
                if (response.ok) {
                    this.message = data.message || 'Synchronisation réussie.';
                    this.status = 'success';
                    ...
                    this.message = data.message || 'Erreur lors de la synchronisation.';
                    this.status = 'error';
                }
            } catch (error) {
    ...
    x-on:open-sync-modal.window="open = true; appareilId = $event.detail.appareilId; appareilName = $event.detail.appareilName"
    class="relative z-50">
            ...
            <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    ...
                    <div class="mt-3 text-center sm:mt-5">
                        ...
                        <div class="mt-4">
                            <p class="text-sm text-gray-500">
                                Cette action va synchroniser les données de l'appareil avec l'application.
                                Assurez-vous que l'appareil est connecté et accessible.
                            </p>
                        </div>
                    </div>
                ...
                <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                    <button type="button" 
                            ...
                            :class="{ 'opacity-75 cursor-not-allowed': synchronizing }">
                        <span x-show="!synchronizing">Synchroniser</span>
                        <span x-show="synchronizing" class="flex items-center">
