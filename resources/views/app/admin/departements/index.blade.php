...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.departements.hierarchie') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-lg flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="21 8 21 21 3 21 3 8"></polyline><rect x="1" y="3" width="22" height="5"></rect><line x1="10" y1="12" x2="14" y2="12"></line></svg>
                Voir la hiérarchie
            </a>
            <a href="{{ route('admin.departements.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Filiale</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($departements as $departement)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $departement->filiale->nom }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        <form action="{{ route('admin.departements.destroy', $departement) }}" method="POST" class="inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce département?');">
                                            @csrf
                                            @method('DELETE')
        ...
        @else
            <div class="p-6 text-center text-gray-500">
                ...
                <p class="text-lg">Aucun département n'a été trouvé.</p>
                <p class="mt-2">Commencez par ajouter un nouveau département pour votre entreprise.</p>
            </div>
        @endif
    </div>
</div>
