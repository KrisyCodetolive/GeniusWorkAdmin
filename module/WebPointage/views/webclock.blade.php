                    ...
                    <div class="card border-0 shadow-sm my-3 overflow-hidden">
                        <div class="p-3 p-sm-3 p-md-4 p-lg-5">
                            <div class="text-center mt-3 mb-5">
                                <h1 class="fw-bolder text-primary">Genius Work</h1>
                            </div>
                            ...
                            <form action="{{Route('getuser')}}" method="post" autocomplete="off" class="col-md-8 m-auto">
                                @csrf
                                <div class="mb-3 text-center">
                                    <label for="idno" class="lead form-label"></label>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-grid mb-3">
                                            <button  type="submit" data-method="clockout" class="btn btn-primary">
                                               VERIFIEZ
                                            </button>
                                        </div>
                                    </div>
        ...
        <div id="myToast" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="true" data-bs-delay="5000">
          ...
          <div class="toast-body">
            <p> 
                ...
                <span id="employee" class="fw-bolder"></span>
            </p>
            <p>
                <span id="type"></span>
