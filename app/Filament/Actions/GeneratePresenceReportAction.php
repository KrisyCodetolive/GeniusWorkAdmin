...
class GeneratePresenceReportAction extends Action
{
    public static function getDefaultName(): ?string
    {
        return 'generatePresenceReport';
    }
        ...
        $this->label('Générer un rapport')
            ...
            ->form([
                Section::make('Paramètres du rapport')
                    ->description('Configurez les options du rapport de présence')
                    ->schema([
            ...
            ->action(function (array $data) {
                ...
                return Redirect::route('rapports.presences.generer', $params);
            });
    }
}
